...
function spiral3D(c) {
  ...
  for (let i = 0; i < 3150; i += 0.5) {
    let r = i / 5.9 +
      (max(0, i / 250) * cos(radians(i / 10 ))) * sin(radians(i * 2 * 4)) +
      (max(0, i / 150) * cos(radians(i / 10 ))) * sin(radians(i * 2 * 4));
...
function spiral3D1(c) {
  ...
  for (let i = 0; i < 3150; i += 0.5) {
    let r = i / 5.9 +
      (max(0, i / 500) * cos(radians(i / 10 + 21))) * sin(radians(i * 2 * 4)) +
      (max(0, i / 550) * cos(radians(i / 15 + 21))) * sin(radians(i * 2 * 4));
    let x = -r * cos(radians(i * 4));
    let y = r * sin(radians(i * 4));
    pg1.vertex(x, y);
  }
