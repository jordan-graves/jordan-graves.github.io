...
sizeValue = "9inch";
  ...
  spiral3D(color(255,255,255));
    ...
    //sw_pg1 = createGraphics(1200, 1200, SVG);
      ...
      stripe = createGraphics(1200, 1200);
 ...
 // sw_pg1.pixelDensity(2);
  ...
  stripe.noFill();
  stripe.stroke(255,255,255);
  stripe.strokeWeight(6);
  for (let i=0; i<stripe.height; i+=20) {
    stripe.line(0,i,stripe.width,i);
  }
}
...
ellipse(0,0,700,700,360);
  ...
  noStroke();
  texture(stripe); // Apply thesw_pg buffer as a texture
