...
c1.clear();
 ...
 // console.log(frameCount);
  for (let i=0; i<min(frameCount*30-0,6100); i+=0.5) {
    let r = i/5.7+a*(max(0,i/350)*cos(radians(i/12+mouseY1)))*sin(radians(i*4*11))
    +a*(max(0,i/180)*cos(radians(i/40+mouseY1)))*sin(radians(i*4*3));
...
c1.clear();
  ...
  c1.noFill();
 // console.log(frameCount);
  for (let i=0; i<min(frameCount*40-2000,6100);i+=0.5) {
    let r = i/5.7+a*(max(0,i/350)*cos(radians(i/12+mouseY1)))*sin(radians(i*4*11))
    +a*(max(0,i/180)*cos(radians(i/40+mouseY1)))*sin(radians(i*4*3));
    let x = 2400/2-r*cos(radians(i*4));
    let y = 2400/2+0+r*sin(radians(i*4));
...
c1.clear();
  ...
  c1.noFill();
 // console.log(frameCount);
  for (let i=0; i<min(frameCount*35-3000,6100); i+=0.5) {
    let r = i/5.7+a*(max(0,i/350)*cos(radians(i/12+mouseY1)))*sin(radians(i*4*11))
    +a*(max(0,i/180)*cos(radians(i/40+mouseY1)))*sin(radians(i*4*3));
    let x = 2400/2-r*cos(radians(i*4));
    let y = 2400/2+0+r*sin(radians(i*4));
